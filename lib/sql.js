...
var sql = {
  ...
  addColumn: function (collectionName, attrName, attrDef) {
    ...
    return 'ALTER TABLE [' + config.dbSchema + '].[' + tableName + '] ADD ' + columnDefinition;
  },
  ...
  removeColumn: function (collectionName, attrName) {
    ...
    return 'ALTER TABLE [' + config.dbSchema + '].[' + tableName + '] DROP COLUMN ' + attrName;
  },
  ...
  insertQuery: function (collectionName, data) {
    ...
    return 'INSERT INTO [' + config.dbSchema + '].[' + tableName + '] ' + '(' + sql.attributes(collectionName, data) + ')' + ' VALUES (' + sql.values(collectionName, data) + '); SELECT @@IDENTITY AS [id]';
  },
